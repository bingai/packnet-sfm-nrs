...
cfg.arch.max_epochs = 5               # Maximum number of epochs
########################################################################################################################
### CHECKPOINT
########################################################################################################################
cfg.checkpoint = CN()
cfg.checkpoint.filepath = ''            # Checkpoint filepath to save data
cfg.checkpoint.save_top_k = 2           # Number of best models to save
...
cfg.datasets.train.num_logs = 2                     # Number of training images to log
########################################################################################################################
### DATASETS.VALIDATION
########################################################################################################################
...
cfg.datasets.validation.num_logs = 2                # Number of validation images to log
########################################################################################################################
### DATASETS.TEST
########################################################################################################################
...
cfg.datasets.test.num_logs = 2                      # Number of test images to log
########################################################################################################################
