...
from packnet_sfm.datasets.valetparking_dataset_utils import \
...
class ValetParkingDataset(Dataset):
    """
    ValetParkingDataset dataset class.
...
########################################################################################################################
    ...
    def _get_intrinsics(image_file, calib_data):
        ...
        for cam in ['left', 'right', 'front', 'rear']:
